...
- ここに書いたのはあくまで一例で、結局は自分にあう方法を模索してそれに取り組み、取捨選択、アップデートを繰り返すのが良いと思います。
...
- だんだんと距離と時間を伸ばして1時間 または 10km 走れるようになったら、ゆるすぎず、きつすぎず のペースで走るようにする
  ...
  - ずーっと同じペースだと続かないので、「ちょっとだけきつめのレベル」を軸に、ペース配分しながら毎日少しずつ成長していくことを期待する
    ...
    - 整理体操
  - 10km ランも自然とできるようなったらやればいいし、できるようになってからでも気が向いたらやるだけでいい。気が向かなければやらなくてもいい。
...
- 3原理・5原則を理解して、少しずつでいいから部位を分けて毎週やること。毎日じゃなくてもいい。できる人はできる範囲でやればいい。
  - できることには個人差があるから。
- お腹が気になる人はバキュームやりましょう。内臓が持ち上がって腹囲が減ります。
...
- EAAを1日3回ほど摂ること。ワークアウト量と拮抗しないようなら、1度に1日量を飲むより、小さく数回に分けて飲む方が吸収率がよい。
  ...
  - EAAには脳疲労を取る効果がある。筋肉の合成も支援される。
- カルシウムを1日650mg以上摂りましょう。マグネシウム入りのサプリメントを変えばなお良いです。
- マルチビタミンを摂りましょう。野菜ジュースでもいいです。
- 食物繊維も摂りましょう。1日1回でいいから口に入れましょう。
  - 面倒なら海苔とか昆布とかをちょっとパリパリすればいいんじゃないですかね。
  - オートミール買うと、炭水化物と食物繊維が取れてハッピーです。ゆかりでもブチ込んでチンすると塩々として美味しいです。
    - チンしたあと、卵を落としてもいいですね。
- よく噛んで食べてください。両方の顎を使って20回~40回噛んで食べると胃がもたれにくくて次の日ラクです。
...
- 腸内細菌叢は脳の活動にも影響を与えることがわかっています。余計な悪影響は減らす方が心も楽です。
...
- ブラウザのタブをOneTabと全タブブクマを利用して、その時に必要な分だけ開くようにしましょう。
  - 次に読みたい記事は、今開いてる奴が終わってから読めばいい。
  - 後で読み返したい、しばらく気に留めたいものは、OneTabに突っ込めばいい。
...
- 寒いとIQが下がるそうです。肉体の力でIQを少し上げましょう。
...
## スタンディングで作業する
スタンディングで作業すると、すぐ横になって寝てしまう習慣を変えられた。
そのままがっつり寝てしまって、起きたら外が暗くなっていて「今日も一日無駄にした...」と暗くならなくてよい。
(別に夜まで寝てても、疲れが取れたならそれでよい)

- 疲れたら座る
- 痔になりにくくなる
- 疲れたら寝転がる
- コツは椅子を少し離れたところにおいて、座る時はデスクから離れて座って休憩する
- 休憩中にスマホとか見るとキリなくなるので、ボーッと退屈を楽しむと良い
- 足が痛くなったら足つぼマットや青竹踏みをおいておいて、それを踏むとすこし楽になる
